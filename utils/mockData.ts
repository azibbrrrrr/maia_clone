...
export const salesOrders: SalesOrder[] = [
  ...
  },
  {
    ...
    progress: { billed: 86, delivered: 100, paid: 0, fulfilled: 0 },
    progressColor: 'red', // Screenshot shows red bar at 47%
    total: 'RM 1,212.00',
  ...
  },
  {
    ...
    status: 'To Fulfill',
    progress: { billed: 100, delivered: 100, paid: 100, fulfilled: 0 },
    progressColor: 'yellow', // Screenshot shows yellow/gold bar at 75%
    total: 'RM 179.00',
  ...
  },
  {
    ...
    creditUtilization: 49,
    status: 'To Bill, Pay and Deliver',
    progress: { billed: 77, delivered: 80, paid: 0, fulfilled: 0 },
    progressColor: 'orange', // Screenshot shows orange at 39%
    total: 'RM 1,212.00',
  ...
  },
  {
    ...
    creditUtilization: 49,
    status: 'To Bill, Pay and Deliver',
    progress: { billed: 86, delivered: 35, paid: 0, fulfilled: 0 },
    progressColor: 'red', // Screenshot shows red at 30%
    total: 'RM 1,318.00',
  ...
  },
  {
    ...
    creditUtilization: 0,
    status: 'To Bill, Pay and Deliver',
    progress: { billed: 50, delivered: 0, paid: 100, fulfilled: 0 },
    progressColor: 'blue', // Screenshot shows blue at 38%
    total: 'RM 869,189.40',
  ...
  },
  {
    ...
    progress: { billed: 100, delivered: 100, paid: 0, fulfilled: 0 },
    progressColor: 'orange', // Screenshot shows orange at 50%
    total: 'RM 321.00',
